...
function Form() {
  return (
    <Container className="form-page" style={{background: '#a8a17d'}}>
        ...
        <Row className="form-page__row">
          ...
          <Col xs={8} md={6}>
            <div className="form-page__inputs">
              <Input type="radio" className="form-page__gender">Herr</Input>
              <Input type="radio" className="form-page__gender">Frau</Input>
            </div>
          </Col>
        </Row>
      </FormGroup>
